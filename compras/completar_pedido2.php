    ...
    <div class="container" id="main">
        <div class="main-form">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend class="text-center">Asi quedaria su compra:</legend>
							<form method="POST" action="https://sandbox.checkout.payulatam.com/ppp-web-gateway-payu/">
								...
								<div class="form-group">
                                    <label>Nombre</label>
                                    <input type="text" class="form-control" name="nombre" placeholder="<?php print $_POST['nombre'] ?>" readonly>
                                </div>
                                <input type="hidden" class="form-control" name="cedula" placeholder="<?php print $_POST['cedula'] ?>" readonly>
								<div class="form-group">
									<label>Correo</label>
									<input type="email" class="form-control" name="buyerEmail" placeholder="<?php print $_POST['buyerEmail'] ?>" readonly >
								</div>
								<input name="shippingCountry"    type="hidden"  value="CO"  >
								<div class="form-group">
                                    <label>Departamento</label>
                                    <input type="text" class="form-control" name="departamento" placeholder="<?php print $_POST['departamento'] ?>" readonly >
                               
                                    <label>Ciudad</label>
                                    <input type="text" class="form-control" name="shippingCity" placeholder="<?php print $_POST['shippingCity'] ?>" readonly >
                                
                                    <label>Dirección de Envio</label>
                                    <input type="text" class="form-control" name="shippingAddress" placeholder="<?php print $_POST['shippingAddress'] ?>" readonly >
                                </div>
								<div class="form-group">
                                    <label>Celular</label>
                                    <input type="number" class="form-control" name="celular" placeholder="<?php print $_POST['celular'] ?>" readonly >
                                </div>
								<div class="form-group">
							...
							<div class="form-group">
								...
								<input value="<?php print $_POST['precio'] ?>" type="text" class="form-control" readonly>
							</div>
							</div>
                    </fieldset>
                </div>
