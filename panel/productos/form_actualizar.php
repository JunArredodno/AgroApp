					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group" >
								...
								<input type="text" name="nombre" value="<?php print $resultado["NombrePro"] ?>" class="form-control" required>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group" >
								...
								<input value="<?php print $resultado["foto"] ?>" type="hidden" class="form-control" name="foto_temp">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group" >
								<label>Precio</label>
								<input type="text" value="<?php print $resultado["precio"] ?>" class="form-control" name="precio" placeholder="0" required>
							</div>
						</div>
					</div>
